...
public class Locator {
    ...
    public void GetSearchResultList() {
        ...
        Integer value = driver.findElements(By.xpath("//li[1]")).size();

        if(driver.findElements(By.xpath("//li[1]")).size()>=1){

            value = value + 1;
            System.out.println("Related to the searched product " + value + " result found.");
        }
        else{
            System.out.println("Related to the searched product " + value + " result found.");
        }
    ...
    public void waitForPageToLoad(int second){
        driver.manage().timeouts().implicitlyWait(second, TimeUnit.SECONDS);
    }

    public  void moveElement(WebElement webElement) throws InterruptedException {
...
//	}
   ...
   /* public boolean switchToFrameByIndex(WebDriver driver,int index) {
    ...
    /*  web element - driver ile kullanım
